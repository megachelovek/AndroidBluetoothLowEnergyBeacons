...
public class EddystoneBeaconFilter<B extends Eddystone> extends GenericBeaconFilter<B> {
    ...
    public EddystoneBeaconFilter() {
    }

    public EddystoneBeaconFilter(UUID... proximityUuids) {
        this(Arrays.asList(proximityUuids));
    }

    public EddystoneBeaconFilter(List<UUID> proximityUuids) {
    ...
    public boolean canMatch(Beacon beacon) {
        return super.canMatch(beacon) && beacon instanceof Eddystone;
    }
